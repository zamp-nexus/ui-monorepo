...
# Ordered by measured Artificial Analysis Intelligence Index, not vendor claim:
# Gemini 3 Flash 38 > GLM-4.7 34 > gpt-oss-120b 24; Opus 5 61 > GPT-5.5 55 >
# Sonnet 5 53. Sonnet 5 leads the premium workhorse chain anyway because it
# reaches 96% of GPT-5.5's score at roughly a third of the blended price.
_GEMINI_FLASH = _free(Provider.GEMINI, "gemini-3-flash")
