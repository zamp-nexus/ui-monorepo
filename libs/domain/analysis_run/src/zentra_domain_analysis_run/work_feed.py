...
class WorkFeedEventKind(StrEnum):
    ...
    ANALYSIS_RUN_QUEUED = "analysis_run.queued"
    ANALYSIS_RUN_STARTED = "analysis_run.started"
    ANALYSIS_RUN_STATUS_CHANGED = "analysis_run.status_changed"
    ANALYSIS_RUN_CANCEL_REQUESTED = "analysis_run.cancel_requested"
    ANALYSIS_RUN_CANCELLED = "analysis_run.cancelled"
    ANALYSIS_RUN_COMPLETED = "analysis_run.completed"
    ANALYSIS_RUN_FAILED = "analysis_run.failed"
    ANALYSIS_RUN_RETRY_CREATED = "analysis_run.retry_created"
...
class AnalysisRunEventPayload(_Payload):
    type: Literal["analysis_run"] = "analysis_run"
