...
the Analysis Run's deterministic policy, deliberately elsewhere.
"""
...
@dataclass(frozen=True, slots=True)
class DraftFinding:
    """An unpublished conclusion, owned by one Organization and one Analysis Run."""
    ...
    def __post_init__(self) -> None:
        ...
        for claim in self.claims:
            ...
            if not claim.metric or claim.value is None:
                ...
                # Analysis Run whose evidence an Organization deleted permanently
