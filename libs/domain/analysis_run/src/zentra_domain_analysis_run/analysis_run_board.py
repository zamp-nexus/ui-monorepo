"""The durable object an Analysis Run accumulates its working memory onto.
...
Analysis Run Board is the shared canvas Work Items read and write for one
Analysis Run. The Orchestrator Loop decides what happens next by reading
