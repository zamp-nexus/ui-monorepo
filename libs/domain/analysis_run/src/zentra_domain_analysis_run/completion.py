"""When an Analysis Run is finished — and when it has merely stopped.
...
deterministic Analysis Run policy (ADR-0011, `evaluate_publication`), and it
...
from .analysis_run_board import AnalysisRunBoard


class CompletionBlocker(StrEnum):
    """A named reason an Analysis Run is not finished.
...
def assess_completion(
    ...
    *,
    ...
    state because neither is a property of what the Analysis Run *knows*: the
