"""One unit of work an Orchestrator Loop assigns against an Analysis Run Board.

See ADR-0026: the Analysis Run Engine replaces a fixed pipeline with a Board
...
class WorkItem:
    """One bounded objective assigned to one Agent Role for one Analysis Run.
