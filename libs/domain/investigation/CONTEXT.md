...
This context's package path (`libs/domain/investigation`) has not yet been
renamed to match; see [[adr/0028-chat-session-and-analysis-run-replace-investigation-thread-and-investigation]]
