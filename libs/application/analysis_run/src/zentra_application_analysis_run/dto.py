...
class PipelineResult:
    """What the agent pipeline established for one analysis_run."""
...
class TimelineEntry:
    ...
    # Set only on an `analysis_run.failed` entry -- the classifier's
...
class AnalysisRunDetail:
    ...
    question: str
    # Read-compatibility only. AnalysisRuns created before free-text
    ...
    # The Phase 2 structured draft, when the AnalysisRun has one. An
    # AnalysisRun that ran before Insight existed has `finding` without
