...
observer is a silent no-op, mirroring `InvestigationService`'s existing
...
from zentra_application_investigation import VisualizationService

NOW = datetime(2026, 8, 3, tzinfo=UTC)
TENANT_ID = UUID("40000000-0000-0000-0000-000000000004")
INVESTIGATION_ID = UUID("50000000-0000-0000-0000-000000000005")
