...
The Open Zentra Design System is built with accessibility as a core principle. All components are designed to meet WCAG 2.1 AA compliance standards.
...
```tsx
import { VisuallyHidden } from '@open-zentra/foundation-design-system';
