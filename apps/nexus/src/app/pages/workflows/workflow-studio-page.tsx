...
export const WorkflowStudioPage = ({ getToken, identity }: { readonly getToken: TokenSource; readonly identity: IdentityContext }) => {
  ...
  const canGrantRawQuery = identity.role === 'admin';
