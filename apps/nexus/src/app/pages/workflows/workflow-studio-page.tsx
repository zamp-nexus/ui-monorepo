...
const canUseDataTools = (role?: string) => role === 'cube_analyst' || role === 'evaluator' || role === 'analyst' || role === 'reviewer';
...
export const WorkflowStudioPage = ({ getToken, identity }: { readonly getToken: TokenSource; readonly identity: IdentityContext }) => {
  ...
  const [routingProfile, setRoutingProfile] = useState<WorkflowRoutingProfile>({ auto_select_enabled: false, purpose: '', tags: [], example_requests: [], priority: 0 });
