...
export const TERMINAL_PHASES: readonly HarvestPhase[] = ['completed', 'failed', 'cancelled'];

export const isTerminal = (phase: HarvestPhase): boolean => TERMINAL_PHASES.includes(phase);
