...
export const latestCatalog = (getToken: TokenSource, dataSourceId: string) =>
  requestJson<CatalogResponse>(`/v1/connector/sources/${dataSourceId}/catalog`, getToken);
...
export const startHarvest = (getToken: TokenSource, dataSourceId: string) =>
  requestJson<HarvestResponse>(`/v1/connector/sources/${dataSourceId}/harvests`, getToken, {
    method: 'POST',
    body: JSON.stringify({}),
  });
