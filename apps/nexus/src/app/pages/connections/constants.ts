...
export const CONNECTION_FAILURE_HELP: Record<string, string> = {
  unreachable:
    'Nothing answered at that host and port. Check the address, the port and whether the service allows this network.',
  authentication_failed:
    'The host answered but rejected those credentials. Check the username and password.',
  database_not_found:
    'The credentials worked, but that database does not exist on the service. Check the database name.',
};
